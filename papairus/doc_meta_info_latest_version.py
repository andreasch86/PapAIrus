...
class EdgeType(Enum):
    ...
    Attributes:
        ...
        subfile_edge: Subfile edge.
        file_item_edge: File item edge.
    """
...
class DocItemType(Enum):
    ...
    Methods:
        ...
        print_self: Print self with color.
        get_edge_type: Get edge type between two items.
    """
    ...
    def to_str(self):
        ...
        Returns:
            String representation of the document item type.
        """
    ...
    def print_self(self):
        ...
        Returns:
            String representation of the document item type with color.
        """
        color = Fore.WHITE
    ...
    def get_edge_type(self, from_item_type: DocItemType, to_item_type: DocItemType):
        """
        Get edge type between two items.

        Args:
            from_item_type: Type of the source item.
            to_item_type: Type of the target item.

        Returns:
            Edge type between the two items.
        """
        pass
...
class DocItem:
    ...
    def get_full_name(self, strict=False):
        ...
        Args:
            strict (bool): Whether to raise an error if the node name is a duplicate.
