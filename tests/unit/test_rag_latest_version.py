...
class DummyLLM:
    """
    A dummy LLM that returns predefined responses.
    
    Args:
        complete_responses: A list of responses to return for the `complete()` method.
        chat_responses: A list of responses to return for the `chat()` method.
    """
    ...
    def complete(self, prompt):
        """
        A method that returns predefined responses for the `complete()` method.
        
        Args:
            prompt: The prompt to complete.
        
        Returns:
            A SimpleNamespace object with the text of the response.
        """
    ...
    def chat(self, *args, **kwargs):
        """
        A method that returns predefined responses for the `chat()` method.
        
        Args:
            *args: The arguments to pass to the `chat()` method.
            **kwargs: The keyword arguments to pass to the `chat()` method.
        
        Returns:
            A SimpleNamespace object with the message of the response.
        """
...
class DummyTextAnalysisTool:
    """
    A dummy text analysis tool that returns predefined responses.
    ...
    def format_chat_prompt(self, message, instruction):
        """
        A method that formats a chat prompt.
